            ...
            <AnimatePresence>
                {visible && !showIOSGuide && (
                    <motion.div
                        ...
                        style={{
                            background:
                                'linear-gradient(135deg, rgba(99,102,241,0.13) 0%, rgba(168,85,247,0.09) 100%)',
                        }}
                    >
                        {/* 장식 블러 */}
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <h3 className="font-black text-[var(--color-text)] text-base leading-tight">
                                        앱으로 설치하면 더 편해요!
                                    </h3>
                            ...
                            <div className="grid grid-cols-2 gap-2 mb-5">
                                {PWA_BENEFITS.map((b) => (
                                    <div
                                        key={b.title}
                                        className="flex items-center gap-2.5 p-3 rounded-2xl bg-white/5 border border-white/5"
                                    >
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] text-[var(--color-text-secondary)] opacity-60 leading-tight mt-0.5">
                                                {b.desc}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="flex gap-3">
                                ...
                                >
                                    <Icon
                                        icon={ios ? 'mdi:export-variant' : 'mdi:download'}
                                        className="text-lg"
                                    />
                    ...
                    <div className="fixed inset-0 z-[9999] flex items-end md:items-center justify-center">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    <h3 className="font-black gradient-text text-xl leading-tight">
                                        iPhone / iPad 설치
                                    </h3>
                                    ...
                                    <div key={step} className="flex gap-3">
                                        ...
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2 mb-0.5">
                                                <Icon
                                                    icon={icon}
                                                    className="text-[var(--color-text-secondary)] text-base flex-shrink-0"
                                                />
